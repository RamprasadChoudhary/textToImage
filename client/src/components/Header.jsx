...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
        ...
        sm:max-w-[590px] mx-auto mt-10 text-center'>Turn text to <span className='text-blue-600'>image</span>, in seconds.</h1>

        <p className='text-center max-w-xl mx-auto mt-5'>Unlash your creativity with our text to image generator. 
            Generate high-quality images in seconds.</p>
        ...
        <p className='mt-2 text-neutral-600 '>Generated images are for demonstration purposes only.</p>
